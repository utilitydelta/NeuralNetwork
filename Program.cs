...
//            var secondLayer = new Layer(100, 28*28);
//            var thirdLayer = new Layer(50, 100);
//            var fourthLayer = new Layer(10, 50);

//            foreach (var item in data)
//            {
//                var blah = new DigitImage(item.Image, item.Label);
//                Console.WriteLine(blah.ToString());
//                Console.ReadLine();

//                var imageDataArray = FlattenAndNormalize(item.Image);
//                var firstLayer = new Layer(imageDataArray);

//                secondLayer.CalculateActivations(firstLayer);
//                thirdLayer.CalculateActivations(secondLayer);
//                fourthLayer.CalculateActivations(thirdLayer);
//                var cost = fourthLayer.CalculateCost(item.Label);
...
//            public Layer(double[] inputLayerActivations)
//            {
//                Neurons = new Neuron[inputLayerActivations.Length];
//                for (var i = 0; i < inputLayerActivations.Length; i++)
//                {
//                    Neurons[i] = new Neuron(inputLayerActivations[i]);
//                }
//            }
...
//            public double[] LabelToArray(byte label)
//            {
...
//            {
//                return string.Concat(Neurons.Select(x => x.Activation + ", "));
//            }

//            public void CalculateActivations(Layer previousLayer)
//            {
//                for (var i = 0; i < Neurons.Length; i++)
//                {
//                    Neurons[i].CalculateActivation(previousLayer);
//                }
//            }

//            public double CalculateCost(byte label)
//            {
//                var expectedResult = LabelToArray(label);
//                double cost = 0.0;
//                for (var resultIndex = 0; resultIndex < 10; resultIndex++)
//                {
//                    cost += Math.Pow(Neurons[resultIndex].Activation - expectedResult[resultIndex], 2.0);
//                }
//                return cost;
//            }
//        }
...
//            public Neuron(double preDefinedActivation)
//            {
//                Activation = preDefinedActivation;
//            }
...
//                {
//                    var weightFlip = rand.NextDouble() < 0.5;
//                    if (weightFlip)
//                    {
...
//                }
//                Bias = rand.Next(30);
//                var flip = rand.NextDouble() < 0.5;
//                if (flip)                  
//                {
//                    Bias *= -1;
//                }
//                Activation = rand.NextDouble();
//            }
...
//                double preNormalisedSumWeights = 0.0;
//                for (var i = 0; i < previousLayer.Neurons.Length; i++)
//                {
//                    preNormalisedSumWeights += previousLayer.Neurons[i].Activation * Weights[i];
//                }
//                preNormalisedSumWeights += Bias;
//                Activation = Sigmoid(preNormalisedSumWeights);
//            }
...
//        private static double[] FlattenAndNormalize(byte[,] image)
//        {
//            var result = new double[image.GetLength(0) * image.GetLength(1)];
//            for (var i = 0; i < image.GetLength(0); i++)
//            {
//                for (var j = 0; j < image.GetLength(1); j++)
//                {
//                    result[i * j] = image[i, j] / 255.0; //Normalize between 0 and 1
//                }
//            }
//            return result;
//        }
